                        ...
                        <div class="div-left ">
                            ...
                            <div class="tiket-left-child pl-5 pr-5 pad-5"> 
                                ...
                                <div class="tt-lienhe mt-4 pl-5 input-f d-block ">
                                    ...
                                    <input type="text"   name="" class="input-ttlh" value="Chu Quang Đạt" >
                                </div>
                                <div class="tt-lienhe mt-5 pl-5 input-f d-block ">
                                    <label class="w-100" for="">Điện thoại</label>
                                    <input type="text"   name="" class="input-ttlh" value="0389820466" >
                                </div>
                                <div class="tt-lienhe mt-5 pl-5 input-f d-block ">
                                    <label class="w-100" for="">Email</label>
                                    <input type="text"   name="" class="input-ttlh" value="quangdatcqd@gmail.com" >
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="div-form-tiket p-2">
                                    <form action="#">
                                        <div class="tt-lienhe mt-5 input-f d-block ">
                                            ...
                                            <input type="text"   name="" class="w-100  " value="3312 6542 4587 9856" >
                                        </div>
                                        <div class="tt-lienhe mt-5 input-f d-block ">
                                            <label class="w-100" for="">Họ tên chủ thẻ</label>
                                            <input type="text"   name="" class="w-100  " value="Chu Quang Đạt" >
                                        </div>
                                        <div class="tt-lienhe   input-f mt-5 d-block  ">
                                            <label class="w-100" for="">Họ tên chủ thẻ</label>  
                                            <div class=" d-flex tt-lienhe   input-f ">
                                                <input type="text" name="" id="date" class="date-ticket-input w40" placeholder="Ngày sử dụng" id="">
